import type { ClawPosition, Rarity } from './types';
...
const NEAR_MISS_TEXTS = ['┬í┬íSE CAE!!', '┬íCASI!', '┬í┬íSE ESCAPA!!', '┬íSE SUELTA!'];
...
export const CHISPINES: ChispinData[] = [
  // Front row ÔÇö biggest, closest to glass
  ...
  { x:  1.2, y: -5.0, z: -1.8, scale: 0.9 },
  // Back row ÔÇö smallest, furthest
